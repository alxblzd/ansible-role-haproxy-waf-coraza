...
Check out the [oxlorg.haproxy Example](https://github.com/O-X-L/ansible-role-haproxy/blob/latest/ExampleCorazaWAF.md) for a full integration example!
...
>              https://github.com/O-X-L/ansible-role-haproxy
